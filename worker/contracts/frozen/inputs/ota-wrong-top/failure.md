# Failure report: `worker-f16-ota-wrong-top-20260926T133407Z-6f89-baseline-cluster-ota`
...
- Identities: request `fec73badec67`, manifest `54529ab9dd66`, source `33aabb1ad7de`
...
- Job `ota6-schematic-run-20260926T133412Z-8f5f` (task `task-b96a1fb1ca104732a40ecb08080dc1f2`); tracker records `~/.asicjobs/ota6-schematic-run-20260926T133412Z-8f5f/{meta,status,result}.json`
- Workspace `/u/home/smandal/.spec2si/sky130/ota6-schematic/runs/task-b96a1fb1ca104732a40ecb08080dc1f2`; collection [collection.json](collection.json)
- Log signatures: traceback 1

## Attempts

- 23 attempt(s) at this request; started 2026-09-26 13:34 UTC, collected 2026-09-26 13:34 UTC
...
Record judgement with `jobs.workflow report --task-key worker-f16-ota-wrong-top-20260926T133407Z-6f89-baseline-cluster-ota --cause <class> --by human|agent [--contradicts ...] [--question ...] [--close ...]`. An agent may declare only gate-fail, tool-error, transport.
