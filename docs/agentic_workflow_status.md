...
| §8 baseline and ablation (A–D) | Condition A **measured** 2026-09-24; B in ordinary use to be re-measured from 2026-10-09; B versus C **measured** 2026-09-26: local tasks tie 18/18; tracked tasks tie 4/4 on correctness, C with less time ($2.18 vs $4.32, 4 vs 10 min) and a structured stop; provisional decision: B for small local tasks, C for tracked, diagnosis and stop tasks | [baseline](agentic_baseline.md): tsmc65, 24 sessions in 25 days, 0 tracked, 375 licensed launches, 5,197 cluster reads, 12.2 h of in-command sleep; 0 of 965 harvested attempts has a declared failure cause |
