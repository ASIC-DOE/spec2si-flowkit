...
| §8 baseline and ablation (A–D) | Condition A **measured** 2026-09-24; B in ordinary use to be re-measured from 2026-10-09; B versus C: the runner and the frozen set are built; on the six local tasks **B and C tie, 18/18 each** (2026-09-26); the tracked half awaits the owner's go-ahead on licensed runs | [baseline](agentic_baseline.md): tsmc65, 24 sessions in 25 days, 0 tracked, 375 licensed launches, 5,197 cluster reads, 12.2 h of in-command sleep; 0 of 965 harvested attempts has a declared failure cause |
